...
# Created by write_sdc on Mon Nov  1 12:26:29 2021
...
create_clock [get_ports CLK]  -name MY_CLK  -period 8.88  -waveform {0 4.44}
set_clock_uncertainty 0.07  [get_clocks MY_CLK]
set_max_delay 8.88  -from [list [get_ports {DIN[13]}] [get_ports {DIN[12]}] [get_ports {DIN[11]}] \
...
{a1_2[13]}] [get_ports {a1_2[12]}] [get_ports {a1_2[11]}] [get_ports           \
{a1_2[10]}] [get_ports {a1_2[9]}] [get_ports {a1_2[8]}] [get_ports {a1_2[7]}]  \
[get_ports {a1_2[6]}] [get_ports {a1_2[5]}] [get_ports {a1_2[4]}] [get_ports   \
{a1_2[3]}] [get_ports {a1_2[2]}] [get_ports {a1_2[1]}] [get_ports {a1_2[0]}]   \
[get_ports {b0[13]}] [get_ports {b0[12]}] [get_ports {b0[11]}] [get_ports      \
{b0[10]}] [get_ports {b0[9]}] [get_ports {b0[8]}] [get_ports {b0[7]}]          \
[get_ports {b0[6]}] [get_ports {b0[5]}] [get_ports {b0[4]}] [get_ports         \
{b0[3]}] [get_ports {b0[2]}] [get_ports {b0[1]}] [get_ports {b0[0]}]           \
[get_ports {b1[13]}] [get_ports {b1[12]}] [get_ports {b1[11]}] [get_ports      \
{b1[10]}] [get_ports {b1[9]}] [get_ports {b1[8]}] [get_ports {b1[7]}]          \
[get_ports {b1[6]}] [get_ports {b1[5]}] [get_ports {b1[4]}] [get_ports         \
{b1[3]}] [get_ports {b1[2]}] [get_ports {b1[1]}] [get_ports {b1[0]}]]
set_max_delay 8.88  -to [get_ports {DOUT[13]}]
set_max_delay 8.88  -to [get_ports {DOUT[12]}]
set_max_delay 8.88  -to [get_ports {DOUT[11]}]
set_max_delay 8.88  -to [get_ports {DOUT[10]}]
set_max_delay 8.88  -to [get_ports {DOUT[9]}]
set_max_delay 8.88  -to [get_ports {DOUT[8]}]
set_max_delay 8.88  -to [get_ports {DOUT[7]}]
set_max_delay 8.88  -to [get_ports {DOUT[6]}]
set_max_delay 8.88  -to [get_ports {DOUT[5]}]
set_max_delay 8.88  -to [get_ports {DOUT[4]}]
set_max_delay 8.88  -to [get_ports {DOUT[3]}]
set_max_delay 8.88  -to [get_ports {DOUT[2]}]
set_max_delay 8.88  -to [get_ports {DOUT[1]}]
set_max_delay 8.88  -to [get_ports {DOUT[0]}]
set_max_delay 8.88  -to [get_ports VOUT]
set_max_delay 8.88  -from [list [get_ports {DIN[13]}] [get_ports {DIN[12]}] [get_ports {DIN[11]}] \
[get_ports {DIN[10]}] [get_ports {DIN[9]}] [get_ports {DIN[8]}] [get_ports     \
{DIN[7]}] [get_ports {DIN[6]}] [get_ports {DIN[5]}] [get_ports {DIN[4]}]       \
[get_ports {DIN[3]}] [get_ports {DIN[2]}] [get_ports {DIN[1]}] [get_ports      \
...
{b1[10]}] [get_ports {b1[9]}] [get_ports {b1[8]}] [get_ports {b1[7]}]          \
[get_ports {b1[6]}] [get_ports {b1[5]}] [get_ports {b1[4]}] [get_ports         \
{b1[3]}] [get_ports {b1[2]}] [get_ports {b1[1]}] [get_ports {b1[0]}]]  -to [list [get_ports {DOUT[13]}] [get_ports {DOUT[12]}] [get_ports            \
